import { a as cn, i as Cta, n as SiteHeader, t as SiteFooter } from "./SiteChrome-CbY4KV0z.js";
import { useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Activity, ArrowRight, Atom, BarChart3, BookOpenCheck, Brain, Database, FlaskConical, Gauge, GraduationCap, Layers, Leaf, LineChart, Puzzle, Radio, Repeat, Sigma, Sparkles, Target, TrendingDown, Users, Wand2 } from "lucide-react";
//#region src/components/landing/Reveal.tsx
				...
				children: [/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [
						/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), "Projeto de Hackathon 2026"]
						}),
						/* @__PURE__ */ jsxs("h1", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Cta, {
								href: "/minigames",
								className: "from-blue-600 to-blue-700 text-white",
								children: ["Entrar", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsx(Cta, {
								href: "#como-funciona",
								variant: "ghostLight",
					...
					children: /* @__PURE__ */ jsx("ul", {
						...
						children: highlights.map(({ icon: Icon, label }) => /* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: /* @__PURE__ */ jsx(Icon, { className: "h-4.5 w-4.5 text-primary-foreground" })
							}), /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/landing/Sections.tsx
var problems = [
	{
		icon: TrendingDown,
...
function Problema() {
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: problems.map(({ icon: Icon, title, text }, i) => /* @__PURE__ */ jsxs(Reveal, {
				as: "li",
				delay: i * 90,
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-destructive" })
					}),
					/* @__PURE__ */ jsx("h3", {
...
function Solucao() {
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: solutions.map(({ icon: Icon, title, text }, i) => /* @__PURE__ */ jsxs(Reveal, {
				as: "li",
				delay: i * 90,
...
function ComoFunciona() {
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: steps.map((step, i) => /* @__PURE__ */ jsx(Reveal, {
				as: "li",
				delay: i * 110,
				className: "relative",
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: i + 1
							}), /* @__PURE__ */ jsx("span", { className: "h-px min-w-0 flex-1 bg-gradient-to-r from-border to-transparent" })]
						}),
						/* @__PURE__ */ jsx("h3", {
...
function Diferenciais() {
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: differentials.map(({ icon: Icon, title, text }, i) => /* @__PURE__ */ jsxs(Reveal, {
				as: "li",
				delay: i * 80,
...
function Exemplos() {
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: useCases.map(({ icon: Icon, subject, topic, text }, i) => /* @__PURE__ */ jsxs(Reveal, {
				as: "li",
				delay: i * 110,
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Icon, { className: "h-6 w-6 text-primary-foreground" })
					}),
					/* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs(Section, {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: [/* @__PURE__ */ jsx("ol", {
				...
				children: architecture.map(({ icon: Icon, label, note }, i) => /* @__PURE__ */ jsxs("li", {
					className: "relative",
					children: [/* @__PURE__ */ jsxs("div", {
					...
					}), i < architecture.length - 1 ? /* @__PURE__ */ jsx(ArrowRight, {
						"aria-hidden": "true",
		...
		children: /* @__PURE__ */ jsxs(Reveal, {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Cta, {
						href: "/fotossintese",
						children: ["Começar Agora", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					}), /* @__PURE__ */ jsx(Cta, {
						href: "#como-funciona",
						variant: "ghostLight",
						children: "Como Funciona"
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					/* @__PURE__ */ jsx(Hero, {}),
					/* @__PURE__ */ jsx(Problema, {}),
					/* @__PURE__ */ jsx(Solucao, {}),
					/* @__PURE__ */ jsx(ComoFunciona, {}),
					/* @__PURE__ */ jsx(Diferenciais, {}),
					/* @__PURE__ */ jsx(Exemplos, {}),
					/* @__PURE__ */ jsx(Arquitetura, {}),
