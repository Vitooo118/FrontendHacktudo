import { n as SiteHeader, r as Button, t as SiteFooter } from "./SiteChrome-CbY4KV0z.js";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Atom, Brain } from "lucide-react";
//#region src/components/quiz/questions.ts
...
//#endregion
//#region src/components/quiz/QuizApp.tsx
function QuizApp() {
	...
	if (!subject) return /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("button", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Brain, { className: "h-8 w-8" })
					}),
					/* @__PURE__ */ jsx("h3", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Atom, { className: "h-8 w-8" })
					}),
					/* @__PURE__ */ jsx("h3", {
						className: "text-xl font-semibold",
						children: "Física"
	...
	if (isFinished) return /* @__PURE__ */ jsx("div", {
		className: "mx-auto max-w-xl text-center",
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: currentQuestion?.options.map((option, index) => /* @__PURE__ */ jsx("button", {
						type: "button",
...
//#endregion
//#region src/routes/quiz.tsx?tsr-split=component
function QuizPage() {
	return /* @__PURE__ */ jsxs("div", {
